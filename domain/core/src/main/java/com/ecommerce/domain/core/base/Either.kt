...
import com.ecommerce.domain.core.base.Either.Left
import com.ecommerce.domain.core.base.Either.Right
...
fun <R> Either<Exception, R>.success(fnR: (R) -> Any): Any = when (this) {
    is Left -> Timber.e(a)
    is Right -> fnR(b)
}
...
fun <R> Either<Exception, R>.error(fnL: (Exception) -> Any): Any = when (this) {
    is Left -> fnL(a)
    is Right -> Unit
}
